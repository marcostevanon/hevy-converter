Fitbod supports multiplier so you can store the weight of some exercises (e.g. dumbbell exercises) for just one arm and the multiplier values ​​tell you whether to multiply to get the total weight
